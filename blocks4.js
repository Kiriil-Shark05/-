...
let sixBlock = document.querySelector('.swiper-container2');
...
let sixBlockWidth = sixBlock.clientWidth;
let vseHeight2 = (oneBlock.clientHeight + threeBlock.clientHeight) - threeBlock.clientHeight;
let vseHeight3 = (oneBlock.clientHeight + threeBlock.clientHeight + fourBlock.clientHeight + sixBlock.clientHeight) - fourBlock.clientHeight;
let vseHeight4 = (oneBlock.clientHeight + threeBlock.clientHeight + sixBlock.clientHeight) - sixBlock.clientHeight;
...
let itog4 = sixBlock.style.top = vseHeight4 + 'px';
